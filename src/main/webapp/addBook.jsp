...
<div class="container mt-5">
    <div class="card p-4 shadow">
        ...
        <form action="addBook" method="post">
            <div class="mb-3">
                Name: <br>
                <input type="text" name="name" placeholder="Book Name" class="form-control mb-2"><br><br>
            </div>
            <div class="mb-3">
                Author: <br>
                <input type="text" name="author" placeholder="Author" class="form-control-mb2"><br><br>
            </div>
