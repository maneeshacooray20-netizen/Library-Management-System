...
<div class="container mt-3">
    <button onclick="toggleDark()" class="btn btn-dark mb-3">
        🌙 Toggle Dark Mode
    </button>
</div>
    ...
    <div class="card p-4 shadow">
        ...
        <table class="table table-bordered table-striped text-center">
            ...
            <tr>
                ...
                <td>
                    <!-- Delete Button -->
                    <a href="deleteBook?name=<%= data[0] %>" class="btn btn-danger btn-sm">Delete</a> |

                    <!-- Update User -->
                    <a href="updateBook.jsp?name=<%= data[0] %>&author=<%= data[1] %>" class="btn btn-warning btn-sm">Update</a>
                </td>
            </tr>
